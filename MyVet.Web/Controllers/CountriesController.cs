...
namespace Sistema.Web.Controllers
{
    public class CountriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Country_Id,Country_Name")] Country country)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Country_Id,Country_Name")] Country country)
        {
