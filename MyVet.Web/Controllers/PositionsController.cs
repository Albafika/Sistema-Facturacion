...
namespace Sistema.Web.Controllers
{
    public class PositionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Position_Id,Position_Name")] Position position)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Position_Id,Position_Name")] Position position)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!PositionExists(position.Position_Id))
                    {
                        return NotFound();
                    }
                    else
